...
var_labels[grep("years", var_labels$variable_label),]
```
...
Goldberg_rutendo %>%
  ...
  select(w12POC_A,w12POC_P) %>%
  mutate(same_race = if_else(w12POC_A == w12POC_P, 'same_poc_relationship','diff_poc_relationship')) %>%
